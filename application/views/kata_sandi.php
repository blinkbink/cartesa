        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                ...
                <div class="container">
                    ...
                    <form method="post" action="<?php base_url()."karyawan/kata_sandi"?>">
                        <div align="center" class="col-md-9">
                            <table cellspacing="1" cellpadding="1">
                                <tr>
                                    <td>Kata Sandi Lama</td>
                                    <td><input name="sandi_lama" type="text" class="form-control" required></td>
                                </tr>
                                <tr>
                                    <td>Kata Sandi Baru</td>
                                    <td><input name="sandi_baru" type="text" class="form-control" required ></td>
                                </tr>
                                <tr>
                                    <td>Konfirmasi Kata Sandi</td>
                                    <td><input name="ulang_sandi" type="text" class="form-control"></td>
                                </tr>
