        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                ...
                <div class="container">
                    ...
                    <div id="page-title">
                        <h2>Pengajuan Perubahan Data</h2>
                    </div>
                    ...
                    <form method="post" action="save">
                        <div align="center" class="col-md-9">
                            <table>
                                <tr>
                                    <td >Email</td>
                                    <td ><input name="email" value="<?php echo $d['email'] ?>" type="text" class="form-control" required oninvalid="this.setCustomValidity('Email Tidak Boleh Kosong')"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="agama" class="form-control">
                                            ...
                                            <option value="Katolik" <?php if($d['agama']=="Katolik") echo 'selected="selected"'?>>Katolik</option>
                                            <option value="Protestan" <?php if($d['agama']=="Protestan") echo 'selected="selected"'?>>Protestan</option>
                                            ...
                                            <option value="Kong Hu Cu" <?php if($d['agama']=="Kong Hu Cu") echo 'selected="selected"'?>>Kong Hu Cu</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Golongan Darah</td>
                                    <td><input name="golongan_darah" value="<?php echo $d['golongan_darah'] ?>" type="text" class="form-control" maxlength="4" required oninvalid="this.setCustomValidity('Golongan Darah Tidak Boleh Kosong')"
                                               oninput="setCustomValidity('')"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="status_perkawinan" class="form-control">
                                            <option value="Belum Menikah" <?php if($d['status_perkawinan']=="Belum Menikah") echo 'selected="selected"'?>>Belum Menikah</option>
                                            <option value="Menikah" <?php if($d['status_perkawinan']=="Menikah") echo 'selected="selected"'?>>Menikah</option>
                                            <option value="Tinggal Cerai" <?php if($d['status_perkawinan']=="Tinggal Cerai") echo 'selected="selected"'?>>Tinggal Cerai</option>
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Nomor KTP</td>
                                    <td><input name="ktp" value="<?php echo $d['nomor_ktp'] ?>" type="text" class="form-control" maxlength="16" required oninvalid="this.setCustomValidity('Nomor KTP Tidak Boleh Kosong')"
                                               oninput="setCustomValidity('')"></td>
                                </tr>

                                <tr>
                                    <td>Nomor HP</td>
                                    <td><input name="hp" value="<?php echo $d['nomor_hp']?>" type="text" class="form-control" maxlength="12" required oninvalid="this.setCustomValidity('Nomor HP Tidak Boleh Kosong')"
                                               oninput="setCustomValidity('')"></td>
                                </tr>
                            </table>
                            ...
                            <div align="right" class="col-md-7">
                                <input type="submit" class="btn display-block font-normal btn-success" value="Simpan">
                            </div>
                            <div class="col-md-1">
