                    ...
                    <div align="center" class="col-md-5">
                        ...
                        foreach ($status as $st)
                            if($st['total'] >= 2) {
                                ?>
                                <div align="center" class="col-md-5">
                                    <a href="<?php echo base_url() . "karyawan/form_izin" ?>" role="button"
                                       class="btn display-block font-normal btn-success" disabled>+ Pengajuan Izin</a>
                                </div>
                                <br><br><br>
                                ...
                                <div align="center" class="col-md-5">
                                    <a href="<?php echo base_url() . "karyawan/form_izin" ?>" role="button"
                                       class="btn display-block font-normal btn-success">+ Pengajuan Izin</a>
                                </div>
                                <?php
                            }
                        ?>
                        ...
                        foreach ($data as $d) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {
                                        ?>
                                        <a href="detail_izin/<?php echo $d['id_izin']?>">Lihat</a>
                                        <a href="batal_izin/<?php echo $d['id_izin']?>" onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan izin ini ?')">Batal</a>
                                        <a href="edit_izin/<?php echo $d['id_izin']?>">Edit</a>
                                        <?php
                                    }
