        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                ...
                <div class="container">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 m-b-lg">
                        <div class="media">
                            <div class="media-left">
                                <img src="<?php echo base_url()."assets/images/gg.png"?>" alt="" class="pull-left foto-personalia">
                            </div>
                            <div class="media-body">
                                <p>
                                    M. Iqbal<br>
                                    <span class="penjelasanShowPersonalia">
                                        Legal & GA Staff
                                        <br>
                                        1 Juli 2002</span>
                                <div class="table_display">
                                    <div class="table_row">
                                        <div class="table_cell sign">
                                            <span class="penjelasanShowPersonalia"><i class="fa fa-phone fa-fw"></i></span>
                                        </div>
                                        <div class="table_cell explanation">
                                            <span class="penjelasanShowPersonalia"></span>
                                        </div>
                                    </div>

                                    <div class="table_row">
                                        <div class="table_cell sign">
                                            <span class="penjelasanShowPersonalia"><i class="fa fa-envelope-o fa-fw"></i></span>
                                        </div>
                                        <div class="table_cell">
                                            <span class="penjelasanShowPersonalia">mip.mip774@gmail.com</span>
                                        </div>
                                    </div>
                                </div>
                                </p>
