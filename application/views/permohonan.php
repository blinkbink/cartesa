        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                ...
                <div class="container">
                    ...
                    <div align="center" class="col-md-1">
                        <form>
                            <select required name="permohonan" class="form-control input-md" style="width:250px" onChange="document.location = this.value" value="GO">
                                <option value="">Pilih</option>
                                <option value="Sakit">Sakit</option>
                                <option value="Izin">Ijin dan Lainnya</option>
                            </select>
                        </form>
                    </div>
                </div>
