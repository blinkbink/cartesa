...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(). "assets/bootstrap/css/button.css"?>">
            ...
            <div id="page-content">
                ...
                <div class="container">
                    ...
                    <form>
                        ...
                        <div align="center" class="col-md-3">
                            <input type="submit" class="btn display-block font-normal btn-success" value="Tampilkan">
                        </div>
                    </form>
