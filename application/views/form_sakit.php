        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                ...
                <div class="container">
                    ...
                    <form method="post" action="<?php echo base_url()."karyawan/form_sakit"?>">
                        <div align="center" class="col-md-9">
                            <table cellspacing="1" cellpadding="1">
                                ...
                                <tr>
                                    <td>Tanggal Sakit</td>
                                    <td><input name="tanggal_izin" type="text" class="form-control" id="datepicker" required ></td>
                                </tr>
                                <tr>
                                    <td>Jumlah Hari Sakit</td>
                                    <td><input name="jumlah_hari" value="1" readonly type="text" class="form-control"></td>
                                </tr>

                                <tr>
                                    <td>Keterangan</td>
                                    <td><textarea name="keterangan" style="overflow:auto;resize:none" rows="6" cols="39" required oninvalid="this.setCustomValidity('Keterangan Tidak Boleh Kosong')" oninput="setCustomValidity('')"></textarea></td>
                                </tr>
                            ...
                            <div align="right" class="col-md-7">
                                ...
                                if($st['total'] > 1) {
                                    ?>
                                    <input name="submit" type="submit" class="btn display-block font-normal btn-success"
                                           disabled value="Simpan">
                                    <p><font color="red">* Tidak dapat mengajukan lebih dari 3</font> </p>
                                    <?php
                                }
                                else {
                                    ?>
                            ...
                            <div class="col-md-1">
                                ...
                                if($st['total'] > 1) {
                                    ?>
                                    <button disabled class="btn display-block font-normal btn-default"
