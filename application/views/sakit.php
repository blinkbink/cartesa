                    ...
                    <div align="center" class="col-md-5">
                        ...
                        foreach ($status as $st)
                            if($st['total'] >= 3) {
                                ?>
                        <div align="center" class="col-md-5">
                                <a href="<?php echo base_url() . "karyawan/form_sakit" ?>" role="button"
                                   class="btn display-block font-normal btn-success" disabled>+ Pengajuan Sakit</a>
                        </div>
                                <br><br><br>
                                <p><font color="red">*</font> Kamu Tidak bisa mengajukan lebih dari 3</p>
                        ...
                        <div align="center" class="col-md-5">
                                <a href="<?php echo base_url() . "karyawan/form_sakit" ?>" role="button"
                                   class="btn display-block font-normal btn-success">+ Pengajuan Sakit</a>
                        </div>
                                <?php
                            }
                        ?>
                            ...
                            foreach ($data as $d) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {
                                        ?>
                                            <a href="detail_sakit/<?php echo $d['id_sakit']?>">Lihat</a>
                                            <a href="batal_sakit/<?php echo $d['id_sakit']?>" onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan sakit ini ?')" >Batal</a>
                                            <a href="edit_sakit/<?php echo $d['id_sakit']?>">Edit</a>
                                        <?php
                                        }
