        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                ...
                <div class="container">
                    ...
                    <form method="post" action="<?php echo base_url(). "karyawan/add_izin"?>">
                        <div align="center" class="col-md-9">
                            <table cellspacing="1" cellpadding="1">
                                <tr>
                                    <td>Tanggal Pengajuan </td>
                                    <td><?php echo date("j F o"); ?></td>
                                    <td><input name="tanggal_pengajuan" type="hidden" value="<?php echo date("Y-m-d");?>" class="form-control" style="width: 300px"></td>
                                </tr>
                                ...
                                <tr>
                                    <td>Keterangan</td>
                                    <td><textarea name="keterangan" style="overflow:auto;resize:none" rows="6" cols="39"></textarea></td>
                                </tr>
                            </table>
