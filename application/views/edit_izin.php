        ...
        <div id="page-content-wrapper">
            <div id="page-content">
                ...
                <div class="container">
                    ...
                    <div id="page-title">
                        <h2>Edit Pengajuan Izin</h2>
                        <p><a href="<?php echo base_url()."karyawan/izin"?>">Kembali</a> </p>
                    </div>
                    ...
                    foreach ($data as $d) {
                    ?>
                    <form method="post" action="<?php echo base_url(). "karyawan/edit_izin/".$d['id_izin'].""?>">
                        <div align="center" class="col-md-9">
                                ...
                                <table cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="jenis_izin" class="form-control" required>
                                                ...
                                                <option value="Izin Menikah" <?php if($d['jenis']=="Izin Menikah") echo 'selected="selected"'?>>Izin Menikah</option>
                                                <option value="Izin Menikahkan Anak" <?php if($d['jenis']=="Izin Menikahkan Anak") echo 'selected="selected"'?>>Izin Menikahkan Anak</option>
                                                <option value="Izin Mengkhitankan Anak" <?php if($d['jenis']=="Izin Mengkhitankan Anak") echo 'selected="selected"'?>>Izin Mengkhitankan Anak</option>
                                                <option value="Izin Melahirkan" <?php if($d['jenis']=="Izin Melahirkan") echo 'selected="selected"'?>>Izin Melahirkan</option>
                                                <option value="Izin Istri Melahirkan" <?php if($d['jenis']=="Izin Istri Melahirkan") echo 'selected="selected"'?>>Izin Istri Melahirkan</option>
                                                <option value="Izin Anak Sakit" <?php if($d['jenis']=="Izin Anak Sakit") echo 'selected="selected"'?>>Izin Anak Sakit</option>
                                                <option value="Izin Duka" <?php if($d['jenis']=="Izin Duka") echo 'selected="selected"'?>>Izin Duka</option>
                                                <option value="Izin Main Game" <?php if($d['jenis']=="Izin Main Game") echo 'selected="selected"'?>>Izin Main Game</option>
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Tanggal Izin</td>
                                        <td><input value="<?php echo $d['tanggal_izin']?>" name="tanggal_izin" type="text" class="form-control" id="datepicker"
                                                   required></td>
                                    </tr>
                                    <tr>
                                        <td>Jumlah Hari Izin</td>
                                        <td><input name="jumlah_hari" value="1" readonly type="text"
